...
public class MainController {
    ...
    public String main(Model model) throws IOException, ParseException {
        ...
        model.addAttribute("weatherinfo", weather1);
        return "index";
    }

    @RequestMapping("/cfr1")
    public String cfr1(Model model) throws IOException, ParseException {
        model.addAttribute("center", "cfr1");
        return "index";
    }

    @RequestMapping("/cfr2")
    public String cfr2(Model model) throws IOException, ParseException {
        model.addAttribute("center", "cfr2");
        return "index";
    }

    @RequestMapping("/ocr1")
    public String ocr1(Model model) throws IOException, ParseException {
    ...
    public String chatbot(Model model, HttpSession httpSession) {
    ...
    public String callcenter(Model model, HttpSession httpSession) {
        if (httpSession.getAttribute("logincust") == null) {
            return "redirect:/login";
        }
