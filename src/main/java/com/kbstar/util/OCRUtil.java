...
public class OCRUtil {
    public static Object getText(String imgpath, String imagname) {
        JSONObject object = null;
        String apiURL = "https://uhucar79op.apigw.ntruss.com/custom/v1/22468/07d046d5fac12b3f82daf5035b9aae86db5adc8275ebfbf05ec83005a4a8ba3e/infer";
        String secretKey = "S1NkRmRBZ0VoZ1dybVR1cHJjSlFidk91aWlGaWp2TE0=";
        String imageFile = imgpath + imagname;
        ...
        try {
            ...
            JSONObject parse = (JSONObject) parser.parse(String.valueOf(response));
            object = parse;
        } catch (Exception e) {
    ...
    public static Map getData(JSONObject result) {
