...
public class OCRUtil {
    ...
    public static Map getData(JSONObject obj){
        ...
        String bizid=(String) a.get("inferText");
        JSONObject b=(JSONObject) fields.get(1);
        String bizname=(String) b.get("inferText");
        JSONObject c=(JSONObject) fields.get(2);
        String bizdate=(String) c.get("inferText");
        JSONObject d=(JSONObject) fields.get(3);
        String bizowner=(String) d.get("inferText");
        JSONObject e=(JSONObject) fields.get(4);
        String bizadd=(String) e.get("inferText");
